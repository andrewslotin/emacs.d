...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-sourcekit swift-mode markdown-mode org go-rename go-playground git-gutter yaml-mode ag zenburn-theme company-go flycheck go-mode dash-at-point tagedit smex rainbow-delimiters projectile magit ido-ubiquitous exec-path-from-shell))))
